      ...
      try {
        ...
        while (currentLoop < MAX_LOOPS && !isFullyDone) {
            ...
            if (streamEndedNaturally) {
                ...
                const continueMsg = "OUTPUT ONLY THE NEXT PART OF THE CODE. DO NOT REPEAT THE LAST LINES. DO NOT START WITH MARKDOWN ```
 IF CONTINUING A BLOCK. IMMEDIATE CONTINUATION ONLY.";

...
 * UPDATE: DEEPSEEK "SLIDING WINDOW" METHOD ENABLED
 * RESULT: Infinite Code Gen + High Speed (No Context Overload)
 * =========================================================
 */
...
                // =========================================================================
                // DEEPSEEK METHOD: SLIDING WINDOW CONTEXT
...
                          // Slice the end
                          effectiveHistory = "/* ...previous code truncated for context... */\n" + fullResponseText.slice(-MAX_CONTEXT_CHARS);
                      }

                      currentMessages.push({ role: "assistant", content: effectiveHistory });
                      currentMessages.push({
                          role: "user",
                          content: "You hit the output limit. CONTINUE generating the code EXACTLY from the last character above. Do not repeat lines. Just write the next part."
                      });
                }

/**
 * =========================================================
 * SPIDER AI — FINAL STABLE BACKEND (v9.5.0)
 * FEATURES: TRUE STREAMING (FIXES TIMEOUTS) + MEMORY
 * Author: M4 Spider
 * =========================================================
 */
...
export async function onRequest(context) {
  ...
  try {
    ...
    //////////////////////
    // STREAM MODE (TRUE STREAMING + MEMORY)
    //////////////////////
                ...
                if (trimmed.startsWith("data:")) {
                  ...
                  try {
                    ...
                    if (textChunk) {
                      ...
                      // Clean bold markers for display on the fly if needed, 
                      // but raw is better for code blocks. 
                      // We send raw to frontend, frontend handles markdown.
                      controller.enqueue(
